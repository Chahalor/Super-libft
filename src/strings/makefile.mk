strings_INCLUDES := -I./src/strings -I./src/strings/_internal -I./src/strings/_internal/append -I./src/strings/_internal/change -I./src/strings/_internal/check -I./src/strings/_internal/memory 
strings_SRCS := \
